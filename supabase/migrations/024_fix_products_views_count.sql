-- ============================================
-- Fix Products Views Count in get_products_with_stats
-- ============================================

-- Update get_products_with_stats to include views_count
...
-- Update get_product_with_stats (singular) to include views_count
